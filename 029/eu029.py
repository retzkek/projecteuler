...
"""
def distinctTerms(nmin,nmax):
    terms=set()
    for a in xrange(nmin,nmax+1):
        for b in xrange(nmin,nmax+1):
            terms.add(pow(a,b))
    return terms
...
if __name__ == "__main__":
    import sys
    print "test:"
    r = len(distinctTerms(2,5))
    if r != 15:
        print "test failed, r=%r != 15" % r
        sys.exit(1)
    print "problem:"
    print len(distinctTerms(2,100))
